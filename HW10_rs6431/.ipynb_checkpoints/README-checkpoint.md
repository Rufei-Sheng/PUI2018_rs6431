...
### Assignment 2. 
This assignment amis at builing model from real life data (the units of the building and its energy consumprion), with analysis polynomial, errors, and likelihood ration.
